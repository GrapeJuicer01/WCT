...
funcParam2VarParam:
    ...
    12GetAcctAcmCycleValue: #关键字，可以随便取名，只要名字不重复
        ...
        OnlyWeb: N   #Y:yes, N:no, A: all
        CatalogName: DP_RULE
    13GetSubsUppInstId: #关键字，可以随便取名，只要名字不重复
        FuncName: GetSubsUppInstId
        Num: 2    #参数个数从1开始计数
        VarName: actionid
        VarType: N   #N:number, F:float, C:char
        OnlyWeb: A   #Y:yes, N:no, A: all
    14GetDependProdInfo: #关键字，可以随便取名，只要名字不重复
        FuncName: GetDependProdInfo
        Num: 1    #参数个数从1开始计数
        VarName: dependoffercode
        VarType: C   #N:number, F:float, C:char
        OnlyWeb: A   #Y:yes, N:no, A: all
    15GetSubsAcmValueByCycle: #关键字，可以随便取名，只要名字不重复
        FuncName: GetSubsAcmValueByCycle
        Num: 1    #参数个数从1开始计数
        VarName: acmid
        VarType: N   #N:number, F:float, C:char
        OnlyWeb: A   #Y:yes, N:no, A: all
    16GetProdAttrValueByAttrCode: #关键字，可以随便取名，只要名字不重复
        FuncName: GetProdAttrValueByAttrCode
        Num: 1    #参数个数从1开始计数
        VarName: attrcode
        VarType: C   #N:number, F:float, C:char
        OnlyWeb: A   #Y:yes, N:no, A: all
    17SetAttrListOTC: #关键字，可以随便取名，只要名字不重复
        FuncName: SetAttrList
        Num: 2    #参数个数从1开始计数
        VarName: param978otc
        VarType: N   #N:number, F:float, C:char
...
addVarName:
    ...
    107extendDay:
        VarName: extendDay
        MatchRule: "r\\.event\\.SetAttrList\\(261,(\\d+)"
        Num: 1 #第几个括号里的字符
        VarType: N  #N:number, F:float, C:char, L: list
        OnlyWeb: A   #Y:yes, N:no, A: all
    108discResB:
    ...
    112recChargeA:
        VarName: recChargeA
        MatchRule: "price_cycle\\=([A-Za-z]+)\\-\\((\\d+)"
        Num: 2 #第几个括号里的字符
        VarType: N  #N:number, F:float, C:char, L: list
        OnlyWeb: N   #Y:yes, N:no, A: all
        CatalogName: RP
    113rechargemax:
        VarName: rechargemax
        MatchRule: "if\\s*\\(recharge\\s*\\<\\=\\-(\\d+)"
        Num: 1 #第几个括号里的字符
        VarType: N  #N:number, F:float, C:char, L: list
        OnlyWeb: Y   #Y:yes, N:no, A: all
    114extendDayA:
        VarName: extendDayA
        MatchRule: "r\\.event\\.SetAttr\\(261,(\\d+)"
        Num: 1 #第几个括号里的字符
        VarType: N  #N:number, F:float, C:char, L: list
        OnlyWeb: A   #Y:yes, N:no, A: all
    115fiftyA:
